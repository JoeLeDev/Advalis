...
export const faqItems: FAQItem[] = [
  {
    id: "arreter-quand-je-veux",
    question: "Est-ce que je peux arrêter quand je veux ?",
    answer: "Oui. Aucun engagement, aucun préavis. Vous êtes libre d'arrêter à tout moment si vous estimez que ce n'est plus adapté à vos besoins."
  },
  {
  ...
  {
    id: "aide-tva-urssaf",
    question: "Est-ce que vous m'aidez à déclarer la TVA ou l'URSSAF ?",
    answer: "Oui, on vous accompagne dans ces démarches, selon votre statut (micro, réel, association). On vous explique quoi faire et on vous envoie des rappels."
  },
  {
    id: "appel-direct",
    question: "Puis-je vous appeler directement ?",
    answer: "Nous privilégions les échanges par WhatsApp pour être plus réactifs, mais des appels peuvent être prévus si nécessaire, selon la formule choisie."
  },
  {
  ...
  {
    id: "associations",
    question: "Et pour les associations ?",
    answer: "On vous aide à suivre votre budget, à classer vos justificatifs, à préparer vos demandes de subventions, et à structurer votre organisation."
  },
  {
    id: "abonnement",
